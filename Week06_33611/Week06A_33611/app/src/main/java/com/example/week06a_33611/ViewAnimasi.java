package com.example.week06a_33611;
...
public class ViewAnimasi extends View {
    private static final int DURASI = 4000; private static final long DELAY = 1000; private static final int PENGATURAN_WARNA = 5; private float mX;
    private float mY;
    ...
    public ViewAnimasi(Context context) { super(context);
    }
